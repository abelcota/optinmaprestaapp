...
import 'package:Optinmapresta/src/elements/DrawerListTitle.dart';
import 'package:Optinmapresta/src/elements/Loader.dart';
import 'package:Optinmapresta/src/elements/RaisedGradientButton.dart';
import 'package:Optinmapresta/src/enum/connectivity_status.dart';
import 'package:Optinmapresta/src/helpers/HexColor.dart';
import 'package:Optinmapresta/src/helpers/SharedPref.dart';
import 'package:Optinmapresta/src/models/menu.dart';
import 'package:Optinmapresta/src/models/navigationIcon.dart';
import 'package:Optinmapresta/src/models/settings.dart';
import 'package:Optinmapresta/src/models/social.dart';
import 'package:Optinmapresta/src/pages/LanguageScreen.dart';
import 'package:Optinmapresta/src/position/PositionOptions.dart';
import 'package:Optinmapresta/src/position/PositionResponse.dart';
import 'package:Optinmapresta/src/themes/UIImages.dart';
...
// ignore: prefer_collection_literals
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  DrawerListTitle(
                      ...
                      onTap: () {
                        flutterWebViewPlugin.launch(settings.url, hidden: true);
      ...
      children: menus
          .map(
            (Menu menu) => DrawerListTitle(
                ...
                text: menu.title,
                onTap: () {
                  flutterWebViewPlugin.reloadUrl(menu.url);
                  Navigator.pop(context);
                }),
          )
          .toList(),
  ...
  actionButtonMenu(
    ...
    if (navigationIcon.type == "url") {
      flutterWebViewPlugin.reloadUrl(navigationIcon.url);
      ...
      switch (navigationIcon.value) {
        case "icon_menu":
          ...
          break;
        case "icon_home":
          flutterWebViewPlugin.reloadUrl(settings.url);
          break;
        case "icon_reload":
